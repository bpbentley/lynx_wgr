...
path_to_plink = "/scratch3/workspace/bbentley_smith_edu-lynx/outputs/popgen/lynx_WGR_pruned_snps"
path_to_sample_coords = "/scratch3/workspace/bbentley_smith_edu-lynx/outputs/popgen/lynx_WGR.coord" 
K = 3 # number of long-range edges to fit
path_to_output_dir = "/scratch3/workspace/bbentley_smith_edu-lynx/feems"

# optional, if chosen change outer=outer in prepare_graph_output
outer = np.loadtxt("/scratch3/workspace/bbentley_smith_edu-lynx/outputs/popgen/lynx_WGR.outer")
...
data_path = str('/scratch3/workspace/bbentley_smith_edu-lynx/outputs/popgen')
ex_path = str(resources.files('feems') / 'data')
grid_path = "{}/grid_100.shp".format(ex_path)
...
cv_err = run_cv_joint(sp_graph, lamb_grid, lamb_q_grid, n_folds=None, factr=1e10)
